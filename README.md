...
- **Midea's cloud backend** (`mapp.appsmb.com`) - Same API as Midea-branded products
- **Midea's V3 LAN protocol** - Encrypted but well-documented
...
- [homebridge-midea-platform](https://github.com/kovapatrik/homebridge-midea-platform) - The Homebridge plugin
- [msmart-ng](https://github.com/mill1000/midea-msmart) - Python library for Midea devices
- [midea_ac_lan](https://github.com/georgezhao2010/midea_ac_lan) - Home Assistant integration with protocol research
